...
<!-- Mirrored from davur.dexignzone.com/frontend/front-booking.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 Mar 2023 11:36:03 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <div class="content-wrapper">
			...
			<div class="container-fluid">
				<div class="form-head dashboard-head d-md-flex d-block mb-5 align-items-start">
					<h2 class="dashboard-title me-auto">Bookings<a  href="javascript:void(0);" data-toggle="modal" data-target="#AddNewCustomer" class="btn btn-success btn-rounded ms-4 text-white d-inline-block">Book New</a></h2>
				...
				<!-- Modal -->
				<div class="modal booking-detail-box" id="BookingDetailBox">
									...
									<div class="row">
										<div class="col-lg-6">
											<div class="form-group">
												<label class="font-w600">Select Date &amp; Time</label>
												<input class="form-control solid" type="datetime-local">
											</div>
										</div>
										<div class="col-lg-6">
											<div class="form-group">
												<label class="font-w600">Select Person</label>
										...
										<div class="col-lg-6">
											<div class="form-group">
												<label class="font-w600">Customer Name</label>
												<input class="form-control solid" type="text" placeholder="Customer Name" value="Samantha Smith">
											</div>
										</div>
										<div class="col-lg-6">
											<div class="form-group">
												<label class="font-w600">Phone Number</label>
												<input class="form-control solid" type="text" placeholder="Phone Number" value="+1 987 654 3210">
											</div>
										</div>
										<div class="col-lg-12">
											<div class="form-group">
												<label class="font-w600">Notes</label>
												<input class="form-control solid" type="text" placeholder="i.g For Anniversary Surprise">
											</div>
										</div>
									</div>
								</form>
